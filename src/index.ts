...
// For generic components (WalletButton, WalletModal, useWallets), import from @laurensv/wallet-standard-vue
export { useWallet, WalletProvider, WALLET_CONTEXT_KEY } from '@laurensv/wallet-standard-vue';
export type * from '@laurensv/wallet-standard-vue';
export type { WalletContext } from '@laurensv/wallet-standard-vue';
